...
const READY_STEPS = ["Type", "Name", "Provider", "Prompt", "Tools", "Skills", "Review"];
const CUSTOM_STEPS = ["Type", "Name", "Framework", "Capabilities", "Delivery", "Review"];
...
const inputStyle: React.CSSProperties = {
  ...
  color: "#f1f5f9",
  boxShadow: "inset 0 1px 0 rgba(255,255,255,0.04), 0 2px 4px rgba(0,0,0,0.15)",
};
  ...
  const handleCreateReady = async () => {
    ...
    try {
      ...
      if (newId) {
        ...
        window.location.href = `/agents/${newId}`;
        return;
      }
      setResult("Created!");
    } catch {
  ...
  const renderStepContent = () => {
    ...
    switch (currentStepName) {
      ...
      case "Provider":
        return (
          <div className="space-y-4">
            <label className="block mb-3" style={{ ...labelStyle, color: colors.textMuted }}>LLM Provider</label>
      ...
      case "Prompt":
        return (
          <div className="space-y-2">
            <label className="block mb-2" style={{ ...labelStyle, color: colors.textMuted }}>System Prompt</label>
            <textarea
              value={systemPrompt}
      ...
      case "Tools":
        return (
          <div className="space-y-3">
            <label className="block mb-3" style={{ ...labelStyle, color: colors.textMuted }}>Built-in Tools</label>
            ...
            <a href="/tools" style={{ fontSize: 12, fontWeight: 500, color: colors.textMuted }}>
              Manage Tools &rarr;
            </a>
          </div>
        );
      ...
      case "Skills":
        return (
          <div className="space-y-3">
            <label className="block mb-3" style={{ ...labelStyle, color: colors.textMuted }}>Agent Skills</label>
      ...
      case "Framework":
        return (
          <div className="space-y-3">
            <label className="block mb-3" style={{ ...labelStyle, color: colors.textMuted }}>Framework</label>
      ...
      case "Capabilities":
        return (
          <div className="space-y-3">
            <label className="block mb-3" style={{ ...labelStyle, color: colors.textMuted }}>Capabilities</label>
            <p className="text-xs mb-3" style={{ color: "#475569", fontWeight: 400 }}>
      ...
      case "Delivery":
        return (
          <div className="space-y-4">
            <label className="block mb-3" style={{ ...labelStyle, color: colors.textMuted }}>Delivery Method</label>
