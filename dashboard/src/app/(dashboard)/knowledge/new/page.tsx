  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <a href="/knowledge" style={{ color: colors.textMuted, fontSize: 14 }}>Back</a>
      </div>
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" value={chunkSize} onChange={(e) => setChunkSize(parseInt(e.target.value) || 500)} style={inputStyle} />
            </div>
            <div>
              <label style={labelStyle}>Chunk Overlap</label>
              <input type="number" value={chunkOverlap} onChange={(e) => setChunkOverlap(parseInt(e.target.value) || 50)} style={inputStyle} />
            </div>
          </div>
